...
public class NumberPicker extends LinearLayout {
     ...
     * returned value is a compound integer, with the resolved size in the {@link
     * #MEASURED_SIZE_MASK} bits and optionally the bit {@link #MEASURED_STATE_TOO_SMALL} set if the
     * resulting size is smaller than the size the view wants to be.
     *
     * @param size How big the view wants to be
     * @param measureSpec Constraints imposed by the parent
     * @return Size information bit mask as defined by {@link #MEASURED_SIZE_MASK} and {@link
     ...
     * NumberPicker#getMinValue()} and {@link NumberPicker#getMaxValue()} values.
     * <p>
     ...
     * <p>
     * If the argument is less than the {@link NumberPicker#getMinValue()} and {@link
     * NumberPicker#getWrapSelectorWheel()} is <code>false</code> the current value is set to the
     * {@link NumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link NumberPicker#getMinValue()} and {@link
     * NumberPicker#getWrapSelectorWheel()} is <code>true</code> the current value is set to the
     * {@link NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link NumberPicker#getMaxValue()} and {@link
     * NumberPicker#getWrapSelectorWheel()} is <code>false</code> the current value is set to the
     * {@link NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * set via {@link #setDisplayedValues(String[])} must be equal to the range of selectable
     * numbers which is equal to {@link #getMaxValue()} - {@link #getMinValue()} + 1.
     */
...
//        }
     ...
     *
     * <strong>Note:</strong> The length of the displayed values array
     * must be equal to the range of selectable numbers which is equal to {@link #getMaxValue()} -
     * {@link #getMinValue()} + 1.
     */
    ...
    /**
     * Updates the accessibility values of the view, to the currently selected value
     */
    ...
    public void smoothScroll(boolean increment, int steps) {
        if (isHorizontalMode()) {
            ...
            if (increment) {
                mFlingScroller
                    .startScroll(0, 0, -mSelectorElementSize * steps, 0, SNAP_SCROLL_DURATION);
            } else {
                mFlingScroller
                    .startScroll(0, 0, mSelectorElementSize * steps, 0, SNAP_SCROLL_DURATION);
            }
            ...
            if (increment) {
                mFlingScroller
                    .startScroll(0, 0, 0, -mSelectorElementSize * steps, SNAP_SCROLL_DURATION);
            } else {
                mFlingScroller
                    .startScroll(0, 0, 0, mSelectorElementSize * steps, SNAP_SCROLL_DURATION);
            }
    ...
    /**
     * Posts a {@link SetSelectionCommand} from the given {@code selectionStart} to {@code
     * selectionEnd}.
     */
     ...
     *
     * @param order Pass {@link #ASCENDING} or {@link #ASCENDING}. Default value is {@link
     * #DESCENDING}.
     */
